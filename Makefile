...
# ==============================================================================
# 🤖 PyNanoClaw Agent (Project A)
# ==============================================================================
.PHONY: run-agent
run-agent: check-env ## Run the PyNanoClaw headless agent with Edinburgh tasks
	@echo "$(MAGENTA)PyNanoClaw — The Headless Automator$(RESET)"
	@echo ""
	$(UV) run python src/pynano_claw.py
